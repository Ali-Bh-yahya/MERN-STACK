...
// const blistPkamn = pokemonfilter(p=> p.name[0] ==="B")
...
const idPkmnNames = pokémon.filter( p => p.id > 99)

console.log(idPkmnNames)

//an array with just the names of the pokémon whose only type is poison


const TypePkmn = pokémon.filter(p => p.types.includes("poison"))
